...
namespace APIVerve
{
    public class PartsOfSpeechAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/partsofspeech";
        ...
        public PartsOfSpeechAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public PartsOfSpeechAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, PartsOfSpeechQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(PartsOfSpeechQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(PartsOfSpeechQueryOptions options)
        {
